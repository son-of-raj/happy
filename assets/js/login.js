      ...
      $('#login_submit').attr('disabled',true);
       ...
       $.ajax({
         ...
         success: function (res) {
          ...
          $('#mobile_no_error1').text('Mobile number not registered or Deactivated...').css('color','red');
          $('#mobile_no_error2').text('Mobile number not registered or Deactivated...').css('color','green');
          $('#mobile_no_error3').text('Mobile number not registered or Deactivated...').css('color','blue');
          $('#login_submit').attr('disabled',true);
...
userMobile: {
 ...
 regexp: {
  regexp: /^[1-9][0-9]{0,15}$/,
  message: "Mobile Number Accept Only Numbers"
    }, 
}
},
  ...
  if(user_logintype=='email')
  {
   ...
   success: function (data) { 
     ...
     {   console.log(obj.response);
       ...
       $('#registration_submit_user').prop('disabled',false).text('Registerwwww');
     }
   }
 } ); 
  }
     ...
     'gender':gender
       ...
       success: function (data) { 
         ...
         {   console.log(obj.response);
           ...
           $('#registration_submit_user').prop('disabled',false).text('Registeraaaaaa');
         }
       }
     } ); 
  }
  ...
  var forgot_mailid=     $('#forgot_mailid').val();
   ...
   success: function (data) { 
     ...
     {   console.log(obj.response);
       ...
       $('#registration_submit_user').prop('disabled',false).text('Registervvvvv');
     }
   }
 } ); 
...
$('#registration_resend').on('click', function() {
 sendEvent('#modal-wizard1', 2);
 $('#otp_error_msg').text('');
 $('#registration_submit_user').prop('disabled',false).text('Registerzzzzz'); ;
 $('#otp_number_user').val('');
...
function open_user_reg_form() { 
    $('#tab_login_modal').modal('hide');     
    $('#modal-wizard1').modal('show');      
}

function open_freelancer_reg_form() {
    $('#tab_login_modal').modal('hide');     
