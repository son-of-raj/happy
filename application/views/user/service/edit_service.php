                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label>Manager <a href="<?php echo base_url() ?>add-staff" class="badge badge-secondary"><i class="fas fa-plus me-2"></i> Add Manager</a></label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="booking_amount" id="booking_amount" value="<?php echo $services['booking_amount']; ?>" required>
                                </div>
                            </div>
