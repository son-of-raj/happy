<?php
    ...
    if(!empty($staff_id)){
		$provider_availability = $this->db->where('provider_id',$user_id)->where('id',$staff_id)->get('employee_basic_details')->row_array();
	}else{
...
<option value="<?php echo $mon_from_time?>"><?php echo $mon_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime1"  data-id="1" name="availability[1][to_time]" <?php echo $day_name[1]; ?>>
                             <?php
...
<option value="<?php echo $tue_from_time?>"><?php echo $tue_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime2"  data-id="2" name="availability[2][to_time]" <?php echo $day_name[2]; ?>>
...
<option value="<?php echo $wed_from_time?>"><?php echo $wed_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime3"  data-id="3" name="availability[3][to_time]" <?php echo $day_name[3]; ?>>
                      <?php
...
<option value="<?php echo $thur_from_time?>"><?php echo $thur_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime4"  data-id="4" name="availability[4][to_time]" <?php echo $day_name[4]; ?>>
                                     <?php
...
<option value="<?php echo $fri_from_time?>"><?php echo $fri_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime5"  data-id="5" name="availability[5][to_time]" <?php echo $day_name[5]; ?>>
                                                  <?php
...
<option value="<?php echo $sat_from_time?>"><?php echo $sat_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime6"  data-id="6" name="availability[6][to_time]" <?php echo $day_name[6]; ?>>
                                 <?php
...
<option value="<?php echo $sun_from_time?>"><?php echo $sun_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime7"  data-id="7" name="availability[7][to_time]" <?php echo $day_name[7]; ?>>
                                                <?php
...
<option value="<?php echo $sun_to_time?>"><?php echo $sun_to_time?></option>
			...
			<input type="hidden" value="<?php echo $amTxt; ?>" id="staff_amtxtval" />
			<input type="hidden" value="<?php echo $pmTxt; ?>" id="staff_pmtxtval" />
