<?php
    ...
    if(!empty($shop_id)){
		$provider_availability = $this->db->where('provider_id',$user_id)->where('id',$shop_id)->get('shops')->row_array();
	}else{
		$provider_availability = $this->db->where('provider_id',$user_id)->get('business_hours')->row_array();
	}
...
<table class="table availability-table">
            ...
            <select class="form-control daysfromtime_check form-select"  name="availability[0][from_time]">
            ...
            <select class="form-control daystotime_check form-select" name="availability[0][to_time]">
 ...
 $mon_to_time=$availability_details[0]['to_time'];
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime1 select_from_time form-select" data-id="1"  name="availability[1][from_time]" <?php echo $day_name[1]; ?>>
              <?php
...
<option value="<?php echo $mon_from_time?>"><?php echo $mon_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select">
            <select class="form-control eachdaytotime eachdaytotime1 form-select"  data-id="1" name="availability[1][to_time]" <?php echo $day_name[1]; ?>>
                             <?php
...
<option value="<?php echo $mon_to_time?>"><?php echo $mon_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime2 select_from_time form-select" data-id="2" name="availability[2][from_time]" <?php echo $day_name[2]; ?>>
                                           <?php
...
<option value="<?php echo $tue_from_time?>"><?php echo $tue_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime2 form-select"  data-id="2" name="availability[2][to_time]" <?php echo $day_name[2]; ?>>
...
<option value="<?php echo $tue_to_time?>"><?php echo $tue_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime3 select_from_time form-select" data-id="3"  name="availability[3][from_time]" <?php echo $day_name[3]; ?>>
                      <?php
...
<option value="<?php echo $wed_from_time?>"><?php echo $wed_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime3 form-select"  data-id="3" name="availability[3][to_time]" <?php echo $day_name[3]; ?>>
                      <?php
...
<option value="<?php echo $wed_to_time?>"><?php echo $wed_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime4 select_from_time form-select" data-id="4" name="availability[4][from_time]" <?php echo $day_name[4]; ?>>
                                    <?php
...
<option value="<?php echo $thur_from_time?>"><?php echo $thur_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime4 form-select"  data-id="4" name="availability[4][to_time]" <?php echo $day_name[4]; ?>>
                                     <?php
...
<option value="<?php echo $thur_to_time?>"><?php echo $thur_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime5 select_from_time form-select" data-id="5" name="availability[5][from_time]" <?php echo $day_name[5]; ?>>
                                                 <?php
...
<option value="<?php echo $fri_from_time?>"><?php echo $fri_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime5 form-select"  data-id="5" name="availability[5][to_time]" <?php echo $day_name[5]; ?>>
                                                  <?php
...
<option value="<?php echo $fri_to_time?>"><?php echo $fri_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime6 select_from_time form-select" data-id="6" name="availability[6][from_time]" <?php echo $day_name[6]; ?>>
                  <?php
...
<option value="<?php echo $sat_from_time?>"><?php echo $sat_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime6 form-select"  data-id="6" name="availability[6][to_time]" <?php echo $day_name[6]; ?>>
                                 <?php
...
<option value="<?php echo $sat_to_time?>"><?php echo $sat_to_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="time-select mb-1">
            <select class="form-control eachdayfromtime eachdayfromtime7 select_from_time form-select" data-id="7" name="availability[7][from_time]" <?php echo $day_name[7]; ?>>
                                               <?php
...
<option value="<?php echo $sun_from_time?>"><?php echo $sun_from_time?></option>
            ...
            <td class="">
            <?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="time-select" >
            <select class="form-control eachdaytotime eachdaytotime7 form-select"  data-id="7" name="availability[7][to_time]" <?php echo $day_name[7]; ?>>
                                                <?php
...
<option value="<?php echo $sun_to_time?>"><?php echo $sun_to_time?></option>
			...
			<input type="hidden" value="<?php echo $amTxt; ?>" id="shop_amtxtval" />
			<input type="hidden" value="<?php echo $pmTxt; ?>" id="shop_pmtxtval" />
