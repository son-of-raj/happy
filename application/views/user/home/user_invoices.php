        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                <div class="row mb-4 provider-input">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <button type="button" class="btn btn-primary me-2 custom-btn-search user_filter_invoice" data-type="s"><i class="fa fa-search"></i></button>
                            <button type="button" class="btn btn-danger custom-btn-search user_filter_invoice" data-type="c"><i class="fa fa-times"></i></button>
                        </div>
                    </div>
