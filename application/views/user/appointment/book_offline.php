				...
				<div class="user-bookings">
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="bookings" role="tabpanel" aria-labelledby="bookings-tab">
							<form method="post" enctype="multipart/form-data" autocomplete="off" id="offline_book_services">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div>
												<select id="offline_service_id" name="service_id" onchange="set_values_by_service(this.value)" class="form-control select addshopcls">
