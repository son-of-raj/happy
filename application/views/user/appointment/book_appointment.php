									...
									<div class="card_body">
										<table class="table table-bordered provider-info mb-0">
											...
											<?php if ($rewardid > 0 && $reward['reward_type'] == 0) { ?>
												<tr>
													<td><?php echo (!empty($this->user_language[$this->user_selected]['lg_Rewards'])) ? $this->user_language[$this->user_selected]['lg_Rewards'] : $this->default_language['en']['lg_Rewards']; ?> </td>
													<td colspan="2"><Strong><?php echo (!empty($this->user_language[$this->user_selected]['lg_Free_Service'])) ? $this->user_language[$this->user_selected]['lg_Free_Service'] : $this->default_language['en']['lg_Free_Service']; ?></strong></td>
												</tr>
											<?php } else { ?>
												<?php if ($offerPrice != '' || $offerqry['id'] > 0) { ?>
													<tr>
														<td><?php echo (!empty($this->user_language[$this->user_selected]['lg_Offers'])) ? $this->user_language[$this->user_selected]['lg_Offers'] : $this->default_language['en']['lg_Offers']; ?> </td>
														<td colspan="2"><Strong><?php echo ($offers['offer_percentage']) ? $offers['offer_percentage'] : $offerqry['offer_percentage']; ?>% <?php echo (!empty($this->user_language[$this->user_selected]['lg_Offers_On_Txt'])) ? $this->user_language[$this->user_selected]['lg_Offers_On_Txt'] : $this->default_language['en']['lg_Offers_On_Txt']; ?> </strong><br><small>(<?php echo date("d M", strtotime($ofsdate)) . ' ' . $totxt . ' ' . date("d M, Y", strtotime($ofedate)) . ' ' . $fromtxt . ' ' . date("G:i A", strtotime($ofstime)) . ' - ' . date("G:i A", strtotime($ofetime)); ?>)</small></td>
													</tr>
												<?php } ?>
												...
												<?php if ($rewardid > 0 && $reward['reward_type'] == 1) { ?>
													<tr>
														<td><?php echo (!empty($this->user_language[$this->user_selected]['lg_Rewards'])) ? $this->user_language[$this->user_selected]['lg_Rewards'] : $this->default_language['en']['lg_Rewards']; ?> </td>
														<td colspan="2"><Strong><?php echo $reward['reward_discount']; ?>% <?php echo (!empty($this->user_language[$this->user_selected]['lg_offer'])) ? $this->user_language[$this->user_selected]['lg_offer'] : $this->default_language['en']['lg_offer']; ?></strong> <i class="text-info small">(<?php echo $reward['description']; ?>)</i></td>
													</tr>
												<?php } ?>
												...
												<?php if ($couponPrice != '') { ?>
													<tr>
														<td><?php echo (!empty($this->user_language[$this->user_selected]['lg_Coupon'])) ? $this->user_language[$this->user_selected]['lg_Coupon'] : $this->default_language['en']['lg_Coupon'] ?> </td>
														<td colspan="2"><Strong><?php echo $coupon['coupon_name']; ?></strong> <i class="text-info small">(<?php echo $coupon['description']; ?>)</i></td>
													</tr>
												<?php } ?>
											<?php } ?>
								...
								<div class="row">
														...
														<div class="additional-content">
															<div class="form-check">
																...
																<label class="form-check-label mb-0" for="addichkbox_<?php echo $a; ?>"><?php echo $ai['service_name']; ?>
																	<p><?php echo $ai['duration'] . "<span class='small'>" . $ai['duration_in'] . "</span>"; ?></span> </p>
																</label>
															</div>
														</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<select class="form-control from_time checkTime select" multiple name="from_time" id="from_time" onchange="set_book_amount()">
											</select>
...
<script>
	...
	function set_book_amount(val) {
		...
		var service_amount = '<?php echo $service_details['service_amount']; ?>';
		var booking_amount = '<?php echo $service_details['booking_amount']; ?>';
