						...
						<div class="table-responsive">
							<table class=" table table-hover table-center mb-0 payment_table">
								...
								<tr>
									...
									<?php if($user_role==1){?>
									<td>
										<a data-id="<?php echo $rows['id']?>"  href="javascript:void(0);" class="btn btn-sm bg-danger-light me-2 delete_review_comment">
											<i class="far fa-trash-alt me-1"></i> Delete
										</a>
									</td>
								<?php }else{?>
									<td>
										<a href="javascript:void(0);" class="btn btn-sm bg-danger-light me-2">
											<i class="far fa-trash-alt me-1"></i> Delete
										</a>
									</td>
							<?php }?>
