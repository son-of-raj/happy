<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<ul class="nav nav-tabs menu-tabs">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo base_url() . 'admin/razorpay-payment-gateway'; ?>">Razor Pay</a>
			</li>
						...
						<form action="<?php echo base_url() . 'admin/settings/paypal_edit/' . $list['id']; ?>" method="post">
							...
							<div class="form-group">
								...
								<?php } else {
									...
									$braintree_key = "" . $strs;
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($braintree_key)) {
																							echo $braintree_key;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
							<div class="form-group">
								...
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($braintree_merchant)) {
																							echo $braintree_merchant;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
							<div class="form-group">
								...
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($braintree_publickey)) {
																							echo $braintree_publickey;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
							<div class="form-group">
								...
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($braintree_privatekey)) {
																							echo $braintree_privatekey;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
							<div class="form-group">
								...
								<?php } else {
									...
									$paypal_appid = "" . $strs;
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($paypal_appid)) {
																							echo $paypal_appid;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
							<div class="form-group">
								...
								<?php } else {
									...
									$paypal_appkey = "" . $strs;
								?>
									<input type="text" id="value" name="value" value="<?php if (!empty($paypal_appkey)) {
																							echo $paypal_appkey;
																						} ?>" class="form-control">
								<?php } ?>
							</div>
