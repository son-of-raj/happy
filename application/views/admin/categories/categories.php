		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-auto text-end">
					<a href="<?php echo $base_url; ?>categories" class="btn btn-white add-button"><i class="fas fa-sync"></i></a>
					<a class="btn btn-white filter-btn" href="javascript:void(0);" id="filter_search">
						<i class="fas fa-filter"></i>
					</a>
					
					<a href="<?php echo $base_url; ?>add-category" class="btn btn-white add-button"><i class="fas fa-plus"></i></a>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-hover table-center mb-0 categories_table" >
								...
								<td style="width:30%;"><img class="avatar-sm rounded me-1" src="'.base_url().$rows['thumb_image'].'" alt="Category Image"> '.$rows['category_name'].'</td>
								...
								<td style="width:30%;">
									<a href="'.base_url().'edit-category/'.$rows['id'].'" class="btn btn-sm bg-success-light me-2">
										<i class="far fa-edit me-1"></i> Edit
									</a>
									<a href="javascript:;" class="on-default remove-row btn btn-sm bg-danger-light me-2 delete_categories '.$display_data.'" id="Onremove_'.$rows['id'].'" data-id="'.$rows['id'].'"><i class="far fa-trash-alt me-1"></i> Delete</a>
								</td>
								</tr>';
