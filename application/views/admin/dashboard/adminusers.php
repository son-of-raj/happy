...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-auto text-end">
					...
					<a href="<?php echo base_url().'adminusers/edit/';?>"><button class="btn btn-primary">Add</button></a>
		...
		<!-- Search Filter -->
		<form action="<?php echo base_url()?>admin/dashboard/adminusers-list" method="post" id="filter_inputs">
      ...
      <a class='btn btn-sm bg-danger-light delete_show' data-id='".$rows['user_id']."'><i class='far fa-trash-alt me-1' ></i> Delete</a>";
					echo'<tr>
					<td>'.$i++.'</td>
					<td>
