...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col">
					<h3 class="page-title">Admin Users Details</h3>
				</div>
				<div class="text-right mb-3">
					<a href="<?php echo base_url()?>adminusers" class="btn btn-primary float-end">Back</a>		
				</div>
			</div>
		</div>
		<!-- /Page Header -->
			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-end mb-0 mb-sm-3">Access Modules</p>
