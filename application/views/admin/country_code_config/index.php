							...
							<tbody>
								...
								?>
											<tr>
												...
												<td>
													<a href="<?php echo base_url().'admin/country_code_config/edit/' . $_id; ?>" class="btn btn-sm bg-success-light me-2"><i class="far fa-edit me-1"></i> Edit</a>&nbsp;
													<?php if($this->session->userdata('role') == 1) { ?>
														<a href="javascript:;" class="on-default remove-row btn btn-sm bg-danger-light me-2 delete_country_code_config" id="Onremove_<?php echo $_id; ?>" data-id="<?php echo $_id; ?>"><i class="far fa-trash-alt me-1"></i> Delete</a>
													<?php } ?>
												</td>
											</tr>
									<?php
