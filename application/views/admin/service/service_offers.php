...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col">
					<h3 class="page-title">Service Offers</h3>
				</div>
				<div class="col-auto text-end">
					<a href="<?php echo $base_url; ?>service-offers" class="btn btn-white add-button"><i class="fas fa-sync"></i></a>
		...
		<!-- Search Filter -->
		<form action="<?php echo base_url()?>service-offers" method="post" id="filter_inputs">
							...
							<table class="table table-hover table-center mb-0 service_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Total Offers</th>
                                ...
                                <tbody>
									...
									foreach ($list as $rows) {
										...
										echo'<tr>
											...
											<td class="text-center"><span class="badge badge-pill btn-primary">'.$rows['total_offers'].'</span></td>											
                                            <td>
											<a href="'.base_url().'offers-details/'.$rows['provider_id'].'" class="btn btn-sm bg-info-light me-3"><i class="far fa-eye me-1"></i>View</a>											
											</td>
										</tr>';
									}
                                    }
