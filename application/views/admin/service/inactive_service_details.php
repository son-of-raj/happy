...
<div class="page-wrapper">
	...
	<div class="content container-fluid">
		<div class="text-right mb-3">
			<a href="<?php echo $base_url; ?>inactive-service-list" class="btn btn-primary">Back</a>
		</div>
		<div class="row">
			<div class="col-lg-8">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="about-author">
							...
							<div class="provider-details">
								<a href="javascript:void(0);" class="ser-provider-name"><?=!empty($provider['name'])?$provider['name']: $provider['name'];?></a>
								<p class="last-seen"> 
