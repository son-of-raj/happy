	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				...
				<a href="<?php echo $base_url; ?>service-list" class="btn btn-primary float-end">Back</a>
				</div>
			</div>
		</div>
		<div class="row">
				...
				<div class="card provider-widget clearfix">
					<div class="card-body">
						...
						<div class="provider-info">
							...
							<p class="mb-0"><i class="fas fa-phone-alt"></i><?php echo $provider['country_code']?>-<?php echo $provider['mobileno']?></p>
						</div>
							<?php } ?>
					</div>
				</div>
