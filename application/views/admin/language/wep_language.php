        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto text-end">
                    <a href="<?php echo $base_url; ?>add-wep-keyword" class="btn btn-white add-button"><i class="fas fa-plus"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action="<?php echo $base_url; ?>update-multi-web-language" onsubmit="update_multi_lang();" method="post" id="form_id">
