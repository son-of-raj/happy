					...
					<div class="row filter-row">
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<label>User</label>
								<select class="form-control select" id="user_id_f" name="token">
									...
									?>
									<option <?php echo $select;?> value="<?php echo $pro['token']?>"><?php echo ucfirst($pro['name']).'-'.$type_name;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						...
						<div class="table-responsive">
                              <table class="table table-hover table-center mb-0 service_table" >
                                ...
                                <tbody>
									...
									$mobileno = ($rows['user_mobile'])?$rows['user_mobile']:'';
									echo '<tr>
										<td>'.$i++.'</td>
										<td>'.$date.'</td>
										<td style="width:30%;">
