...
class Appointment_model extends CI_Model
{
	...
	{
		$ret = $this->db->select('tab_1.provider_id, tab_1.user_id, tab_1.status, tab_1.currency_code, tab_1.amount, tab_2.service_offer_name as service_title')->from('book_service as tab_1')->join('shop_services_list as tab_2', 'tab_2.id=tab_1.service_id', 'LEFT')->join('shops as tab_3', 'tab_3.id=tab_1.shop_id', 'LEFT')->where('tab_1.id', $book_service_id)->limit(1)->order_by('tab_1.id', 'DESC')->get()->row_array();
		return $ret;
	}
	...
	public function get_booking_offers_by_service($service_id)
	{
