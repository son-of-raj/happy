...
class Booking_report_model extends CI_Model
{
 ...
 public function get_total_bookings(){
    ...
    $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on, tab_1.admin_change_status');
	 ...
	 $this->db->where("tab_1.status != 8"); //Hide Onhold booking
	 $this->db->where("tab_1.guest_parent_bookid = 0"); // No Guest Details
...
/*booking reports*/
 ...
 public function get_reject_bookings(){
                            ...
                            $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,,tab_1.admin_change_status,tab_1.reject_paid_token,tab_1.admin_reject_comment,tab_1.cod,tab_1.parent_bookid,tab_1.autoschedule_session_no');
                                     $this->db->select('tab_2.service_title');
                                     $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
                                     $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
                                     $this->db->from('book_service tab_1');
...
/*booking reports*/
 ...
 public function get_filter_cancel_bookings($service_id,$status,$user_id,$provider_id,$from,$to){
          ...
          $to_date='';
                                     ...
                                     $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.admin_change_status,tab_1.cod,tab_1.parent_bookid,tab_1.autoschedule_session_no');
                                     $this->db->select('tab_2.service_title');
                                     $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img');
                                     $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img');
                                     $this->db->from('book_service tab_1');
 ...
 /*total*/
  ...
  public function get_reject_bookings_by_id($id){
                            ...
                            $this->db->select('tab_1.id,tab_1.location,tab_1.service_date,tab_1.currency_code,tab_1.amount,tab_1.currency_code,tab_1.from_time,tab_1.to_time,tab_1.notes,tab_1.latitude,tab_1.longitude,tab_1.request_date,tab_1.request_time,tab_1.status,tab_1.reason,tab_1.updated_on,tab_1.status as payment_status, tab_1.service_id');
                                     $this->db->select('tab_2.service_title');
                                     $this->db->select('tab_3.name as user_name,tab_3.mobileno as user_mobile,tab_3.email as user_email,tab_3.profile_img as user_profile_img,tab_3.token as user_token, tab_3.type as user_type');
                                     $this->db->select('tab_4.name as provider_name,tab_4.mobileno as provider_mobile,tab_4.email as provider_email,tab_4.profile_img as provider_profile_img,tab_4.token as provider_token, tab_4.type as provider_type');
                                     $this->db->from('book_service tab_1');
                                     $this->db->join('services tab_2','tab_2.id=tab_1.service_id','LEFT');
                                     $this->db->join('users tab_3','tab_3.id=tab_1.user_id','LEFT');
                                     $this->db->join('providers tab_4','tab_4.id=tab_1.provider_id','LEFT');
