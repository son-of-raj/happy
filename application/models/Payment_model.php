...
class Payment_model extends CI_Model
{
  ...
  public function __construct()
  {
    ...
    {
       $this->db->select('B.*,U.name as username,S.service_title,P.name');
      $this->db->from('book_service B');
      $this->db->join('users U','U.id=B.user_id','left');
      $this->db->join('providers P','P.id=B.provider_id','left');
    ...
    public function selletBalance() {
        $this->db->select('user_provider_id, wallet_amt,P.name as provider_name');
        $this->db->from('wallet_table W');
        $this->db->join('providers P','P.id=W.user_provider_id','left');
