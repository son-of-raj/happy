	...
	<div class="container">
		<div class="row justify-content-center">
            <div class="col-lg-10">
				...
				<form method="post" enctype="multipart/form-data" autocomplete="off" id="book_service" action="<?php echo base_url()?>update-status-user" class="check_user_reason" >
					<div class="row">
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label><?php echo (!empty($user_language[$user_selected]['lg_From_time'])) ? $user_language[$user_selected]['lg_From_time'] : $default_language['en']['lg_From_time']; ?> <span class="text-danger">*</span></label>
								<input class="form-control" type="text"  name="from_time" id="from_time" value="<?php echo $st_time?>" readonly>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label><?php echo (!empty($user_language[$user_selected]['lg_To_time'])) ? $user_language[$user_selected]['lg_To_time'] : $default_language['en']['lg_To_time']; ?> <span class="text-danger">*</span></label>
