                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="<?php echo base_url().'admin/footer_submenu/edit/' . $_id; ?>" class="btn btn-sm bg-success-light me-2"><i class="far fa-edit me-1"></i> Edit</a>&nbsp;
												<a href="javascript:void(0)" class="on-default remove-row btn btn-sm bg-danger-light me-2 delete_footer_submenu" id="Onremove_<?php echo $_id; ?>" data-id="<?php echo $_id; ?>"><i class="far fa-trash-alt me-1"></i> Delete</a>
