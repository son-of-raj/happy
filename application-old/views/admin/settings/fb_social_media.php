                ...
                <div class="card">
                    <div class="card-body">
                        <div class="nav flex-column">
                            ...
                            <a class="nav-link" data-bs-toggle="tab" href="#privacy">Privacy</a>
                            <a class="nav-link mb-0" data-bs-toggle="tab" href="#about">About Us</a>
                            <a class="nav-link mb-0 active" data-bs-toggle="tab" href="#seo">SEO</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card mb-0">
                                        ...
                                        <div class="card-body">
											...
											<div class="form-group">
													...
													?>
												<input type="radio" required="" <?php echo $fdis?> class="login_type" name="login_type"  value="mobile" <?php echo (!empty($login_type)&&$login_type=="mobile")?"checked":"";?>>
												Mobile No &nbsp;	
												<input type="radio" required="" <?php echo $fdis?> class="login_type" name="login_type"  value="email" <?php echo (!empty($login_type)&&$login_type=="email")?"checked":"";?>>
												Email ID
											</div>
