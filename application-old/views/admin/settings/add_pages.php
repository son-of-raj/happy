					...
					<div class="card-body">
						<form action="<?php echo base_url()?>admin/settings/add_pages" id="add_pages" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
                                ...
                                <select class="form-control select" name="pages_lang" id="pages_lang" required>
							...
							<div class="form-group">
								<label>Location</label><br>
								 <label><input type="radio" name="pages_loc" value="1" required> Top Menu </label>&nbsp
								 <label><input type="radio" name="pages_loc" value="2">Quick Links</label>
							</div>
							<div class="form-group">
								 <label>Visibility</label><br>
								 <label><input type="radio" name="pages_visibility" value="1" required> Show </label>&nbsp
								 <label><input type="radio" name="pages_visibility" value="2"> Hide</label>
							</div>
							<div class="form-group">
								<label>Content</label>
							...
							<div class="mt-4">
								<?php if($user_role==1){ ?>
								<button class="btn btn-primary " name="form_submit" value="submit" type="submit">Add Pages</button>
							<?php }?>
