		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-auto text-end">
					<a href="<?php echo $base_url; ?>subcategories" class="btn btn-white add-button"><i class="fas fa-sync"></i></a>
					<a class="btn btn-white filter-btn" href="javascript:void(0);" id="filter_search">
						<i class="fas fa-filter"></i>
					</a>

					<a href="<?php echo $base_url; ?>add-subcategory" class="btn btn-white add-button">
					...
					<div class="row filter-row">
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								...
								<select class="form-control select" name="category" id="main_category">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-hover table-center mb-0 categories_table" >
								...
								echo'<tr>
								<td>'.$i++.'</td>
								<td><img class="avatar-sm rounded me-1" src="'.base_url().$rows['subcategory_image'].'"> '.$rows['subcategory_name'].'</td>
								<td>'.$rows['category_name'].'</td>
								<td>'.$date.'</td>
								<td><a href="'.base_url().'edit-subcategory/'.$rows['id'].'" class="btn btn-sm bg-success-light me-2"><i class="far fa-edit me-1"></i>Edit</a>
								<a href="javascript:;" class="on-default remove-row btn btn-sm bg-danger-light me-2 delete_subcategories '.$display_data.'" id="Onremove_'.$rows['id'].'" data-id="'.$rows['id'].'" ><i class="far fa-trash-alt me-1"></i> Delete</a>
								</td>
								</tr>';
